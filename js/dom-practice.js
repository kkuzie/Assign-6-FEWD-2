...
btn2.onclick = function () {
    alert("Step 2 - I have been clicked too");
};
...
btn3.addEventListener('click', e => {
    alert('Step 3 - I have been clicked as well');
});
...
function step4(){
    alert('Step 4 - I have been clicked like the others');
}
...
start.addEventListener ('click', e => {
    const timer = setInterval(() => {
        console.log('Learning JavaScript is hell!');
